...
=== "Google Cloud"
    Google 提供两种访问其模型的方式：Google AI Studio 和 Google Cloud Vertex AI。Google AI Studio 仅需 Google 账号和 API 密钥，Vertex AI 需要 Google Cloud 账号。若刚开始使用，可选择 Google AI Studio。

    首先安装所需包（根据所选 API 仅安装需要的包）：
    ...
    有关可用模型、功能和配置的更多信息，请参阅：[Google AI Studio 文档](https://ai.google.dev/docs)、[Google Cloud Vertex AI 文档](https://cloud.google.com/vertex-ai/docs)、[LangChain Google AI 集成](https://python.langchain.com/docs/integrations/chat/google_generative_ai)、[LangChain Vertex AI 集成](https://python.langchain.com/docs/integrations/chat/google_vertex_ai)
